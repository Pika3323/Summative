...
bool LevelSaveState::bLocalMenu = true;
...
void LevelSaveState::Pause(){

}
void LevelSaveState::Resume(){

}

void LevelSaveState::HandleEvents(ALLEGRO_EVENT *ev){
...
void LevelSaveState::Tick(float delta){
